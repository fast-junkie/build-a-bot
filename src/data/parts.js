  ...
  heads: [
    {
      ...
      title: 'Large Cyclops',
      src: '/assets/img/head-big-eye.png',
      type: 'heads',
      cost: 1225.5,
    },
    {
      ...
      title: 'Friendly Bot',
      src: '/assets/img/head-friendly.png',
      cost: 945.0,
      type: 'heads',
      onSale: true,
    },
    {
      ...
      title: 'Shredder',
      src: '/assets/img/head-shredder.png',
      type: 'heads',
      cost: 1275.5,
    },
    {
      ...
      title: 'Small Cyclops',
      src: '/assets/img/head-single-eye.png',
      type: 'heads',
      cost: 750.0,
    },
    {
      ...
      src: '/assets/img/head-surveillance.png',
      type: 'heads',
      cost: 1255.5,
    },
  ],
  arms: [
    {
      ...
      title: 'Articulated',
      src: '/assets/img/arm-articulated-claw.png',
      type: 'arms',
      cost: 275,
    },
    {
      ...
      title: 'Two Clawed',
      src: '/assets/img/arm-dual-claw.png',
      type: 'arms',
      cost: 285,
    },
    {
      ...
      title: 'Grabber',
      src: '/assets/img/arm-grabber.png',
      type: 'arms',
      cost: 205.5,
    },
    {
      ...
      title: 'Propeller',
      src: '/assets/img/arm-propeller.png',
      type: 'arms',
      cost: 230,
      onSale: true,
    },
    {
      ...
      title: 'Stubby Claw',
      src: '/assets/img/arm-stubby-claw.png',
      type: 'arms',
      cost: 125,
    },
  ],
  torsos: [
    {
      ...
      src: '/assets/img/torso-flexible-gauged.png',
      type: 'torsos',
      cost: 1575,
    },
    {
      ...
      title: 'Gauged',
      src: '/assets/img/torso-gauged.png',
      type: 'torsos',
      cost: 1385,
    },
    {
      ...
      title: 'Gauged',
      src: '/assets/img/torso-pouch.png',
      type: 'torsos',
      cost: 785,
      onSale: true,
    },
  ...
  bases: [
    {
      ...
      src: '/assets/img/base-double-wheel.png',
      type: 'bases',
      cost: 895,
    },
    {
      ...
      title: 'Rocket',
      src: '/assets/img/base-rocket.png',
      type: 'bases',
      cost: 1520.5,
    },
    {
      ...
      src: '/assets/img/base-single-wheel.png',
      type: 'bases',
      cost: 1190.5,
    },
    {
      ...
      title: 'Spring',
      src: '/assets/img/base-spring.png',
      type: 'bases',
      cost: 1190.5,
    },
    {
      ...
      src: '/assets/img/base-triple-wheel.png',
      type: 'bases',
      cost: 700.5,
    },
  ],
